            ...
            <div>
                <div class="ays-quiz-subtitle-main-box">
                    <p class="ays-subtitle">
                        ...
                        <a href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" title="<?php echo __('This property aviable only in pro version',$this->plugin_name); ?>" style="float: right;background: rgba(0,0,0,.1);" class="button disabled-button"><?php echo __('Embed code', $this->plugin_name); ?></a>
                    </p>
                    <?php if(isset($id) && count($get_all_quizzes) > 1):?>
