...
Simple and easy way to create and display information cards anywhare. 

== Description ==

👉 [Plugin Demo](https://bblockswp.com/demo/info-cards) | [Documentation](https://bplugins.com/docs/)  👈

The Info Cards Block Plugin for WordPress allows you to create beautifully designed and informative cards within your content. With this plugin, you can present your content in an interactive and engaging way, making it easier for your audience to consume and understand your message.
...
1. Go to Plugins > Add New from WordPress admin dashboard. 
2. Search "Info Cards" In the search field.  
3. Install Info Cards plugin 
...
Yes, If you need any service form us please email at support[a]bplugins.com
